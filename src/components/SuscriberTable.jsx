                ...
                <div className="bg-white shadow-md rounded my-6">
                    <table className="min-w-max w-full table-auto">
                        ...
                        <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            ...
                            <th className="py-2 px-6 text-center">Filiere</th>
                            <th className="py-2 px-6 text-center">Spécialité</th>
                            <th className="py-2 px-6 text-center">Axe</th>
                        ...
                        <tr className="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td className="py-3 px-6 text-left">
                                <div className="flex items-center">
                                    <div className="mr-2">
                                        <img alt="suscriber" className="w-6 h-6 rounded-full" src="https://unsplash.com/photos/0VEDrQXxrQo"/>
                                    </div>
                                    <span>Schuame</span>
                                </div>
                            </td>
